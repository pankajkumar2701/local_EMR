...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "local_EMR", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<local_EMRContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "local_EMR API v1");
